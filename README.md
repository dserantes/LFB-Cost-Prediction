# LFB
This ML-project (Jupyter Notebook) aims to predict the notional cost of an incident caused in London-city territory &amp; solved by the LFB, helping the organization's system and its relative budget.
